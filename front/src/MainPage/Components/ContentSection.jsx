  ...
  return (
    <div>
      <div className="flex items-center text-gray-500 font-medium text-sm justify-between space-x-2">
        ...
        <div className="flex">
          <button className="text-gray-800 font-bold py-2 px-4 rounded flex items-center transition-all duration-300 ease-in-out transform hover:scale-110 hover:text-blue-500">
